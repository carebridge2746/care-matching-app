...
import type { PublicReviewRow, ReviewRow, UserRatingRow } from '@/api/database.types';
...
import { EmptyRating, type PublicReview, type Review, type UserRating } from '@/types';
...
const Columns = 'id, match_id, reviewer_id, reviewee_id, rating, comment, created_at';
